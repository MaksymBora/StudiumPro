...
export function SingleProductContentWrapper() {
  ...
  const portsText = specs ? formatPorts(specs.portsDescription) : '';
                            ...
                            <div className="row small">
                              <div className="col-md-6">
                                <ul className="list-unstyled mb-2">
                                  ...
                                  <li>
                                    <span className="fw-semibold">Storage:</span> {specs.storageGb} GB{' '}
                                    {specs.storageType} ({specs.storageInterface})
                                  </li>
                                  <li>
